...
import SpaceItem from '../event-spaces/space-item'
...
class SpaceSlide extends React.Component {
  ...
  render() {
    moment.locale('en')
    const {t, showLink, showMoreAs, showMoreHref} = this.props
    let { spaces, dragging, windowWidth } = this.state
    const settings = SlickSliderSettings.FLEXIBLE_DESK_SETTINGS
