...
function SearchOffice(props) {
  ...
  const handleSearch = () => {
    ...
    const { provinceSelect, areaSelect, districtSelect, priceSelect, capacitySelect } = props
    if (provinceSelect) {
  ...
  return (
    <div className="search-box">
      <div className={classes.searchInputGroup}>
        ...
        <div className={`${classes.searchInputWrap} ${classes.searchInputWrapLast}`}>
          <Dropdown
      ...
      <div className="d-flex">
        <div className={`${classes.searchInputGroup} flex-auto `} style={{ marginRight: '12px' }}>
          <Dropdown isOpen={dropdownCapacityOpen} toggle={toggleCapacity} className={classes.dropdown}>
            <DropdownToggle
              tag="span"
              data-toggle="dropdown"
        ...
        <Button color="custom" className={`${classes.btnSearch} btn-main`} onClick={handleSearch}>
          Tìm kiếm
        </Button>
      </div>
    </div>
